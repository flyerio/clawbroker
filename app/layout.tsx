...
export const metadata: Metadata = {
  title: "ClawBroker AI | AI-Powered CRE Team",
  description:
    "ClawBroker AI is a commercial real estate AI platform for CRE brokers. Property search, demographic analysis, document extraction, market monitoring, and client memory — all from Telegram.",
  keywords: [
  ...
  openGraph: {
    title: "ClawBroker AI | Your CRE AI Team",
    description:
      "AI-powered property search, demographics, document extraction, and market monitoring for CRE brokers.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ClawBroker AI — Your CRE AI Team",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "ClawBroker AI | CRE AI Team",
    description:
...
const organizationSchema = {
  ...
  description:
    "AI-powered commercial real estate platform for CRE brokers and brokerage firms.",
  foundingDate: "2024",
  sameAs: [
...
const softwareSchema = {
  ...
  description:
    "Commercial real estate AI platform with property search, demographic analysis, document extraction, market monitoring, client memory, and chart generation for CRE brokers.",
  featureList: [
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "ClawBroker AI is a commercial real estate AI platform that provides CRE brokers with an AI team accessible via Telegram. It handles property search, demographic analysis, document extraction, market monitoring, client memory, and chart generation — all from your phone, 24/7.",
      },
    },
    {
      "@type": "Question",
